...
class Truncate extends Instruccion{
    ...
    ejecutar(entorno){
        ...
        s.add_Simbolo(new Simb(this.numero.valor,"Funcion Nativa","Truncate",entorno.nombre,this.linea,this.columna));
        this.numero.valor = Math.trunc(this.numero.valor);
    ...
    getAst(){
        ...
        nodo.padre = "nodotruncate"+aleatorio.toString();
