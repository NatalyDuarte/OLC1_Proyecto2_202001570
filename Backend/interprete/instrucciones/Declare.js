...
class Declare extends Instruccion{
    ...
    ejecutar(entorno){
        ...
        s.add_Simbolo(new Simb(this.expresion.valor,"Declarar",expresion.tipo,entorno.nombre,this.linea,this.columna));
    }
    getAst(){
        let nodo = {
            padre: "",
        ...
        nodo.padre = "nododeclarar"+aleatorio.toString();
        const val =this.expresion.getAst();
        nodo.cadena =` 
        ${nodo.padre}[label ="DECLARAR"];
